    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
        <CardHeader className="text-center pb-4">
          <div className="mx-auto mb-4 p-4 bg-gradient-to-br from-red-100 to-orange-100 rounded-full w-20 h-20 flex items-center justify-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. Halaman
            ini hanya dapat diakses oleh Administrator.
          </p>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <Button
              ...
              variant="ghost"
              className="w-full text-red-600 hover:bg-red-50 hover:text-red-700 font-medium py-2 rounded-lg transition-colors">
              Keluar dari Akun
            </Button>
          </div>
