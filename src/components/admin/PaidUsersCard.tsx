      ...
      <CardHeader>
        ...
        <div className='flex flex-wrap items-center gap-2 mt-4'>
          ...
          <Select value={selectedMonth} onValueChange={setSelectedMonth}>
            <SelectTrigger className='w-[200px] border-green-300 focus:ring-green-500 focus:border-green-500 hover:border-green-500 hover:bg-green-50 cursor-pointer'>
      ...
      <CardContent>
        {error ? (
          <div className='text-center py-8'>
            ...
            <Button
              onClick={() => fetchPaidUsers(selectedMonth)}
              variant='outline'
            >
              Coba Lagi
            </Button>
